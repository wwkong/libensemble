...
libE_specs['safe_mode'] = False  # Yeah, overhead is considerable as H becomes long.

persis_info = add_unique_random_streams({}, nworkers + 1)

# SH TODO: Replace with function attributes - internal to alloc functions? Well atleast the counter...
# total_gens can prob be an alloc_specs.
persis_info['next_to_give'] = 0
persis_info['total_gen_calls'] = 1

#exit_criteria = {'sim_max': 50000, 'elapsed_wallclock_time': 300}
